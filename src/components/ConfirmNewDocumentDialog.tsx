...
interface ConfirmNewDocumentDialogProps {
  open: boolean
...
/**
 * P0-1 新建文档确认：当前文档有内容时，新建前弹确认，防止误清空。
 */
export function ConfirmNewDocumentDialog({
  open,
  onOpenChange,
  onConfirm,
}: ConfirmNewDocumentDialogProps) {
...
export default ConfirmNewDocumentDialog
